...
public interface SesUserInstanceMapper {
	...
	int updateByExampleSelective(@Param("record") SesUserInstance record,
			@Param("example") SesUserInstanceCriteria example);

	int updateByExample(@Param("record") SesUserInstance record,
			@Param("example") SesUserInstanceCriteria example);

/*
	* @(#)IpaasStormTaskSpout.java	2015年03月25日
	*
...
* @author weichuang
*/
public class StormTaskSpoutVo implements java.io.Serializable{
	...
	//默认构造器
	public StormTaskSpoutVo(){
	}
	//全属性构造器
	public StormTaskSpoutVo(Long id,Long taskId,String spoutName,String spoutClassName,Integer threads){
		this.id = id;
		this.taskId = taskId;
	...
	public boolean equals(Object obj) {
		...
		return false;
		StormTaskSpoutVo other = (StormTaskSpoutVo) obj;
	if (id == null) {
		if (other.id != null)
			return false;

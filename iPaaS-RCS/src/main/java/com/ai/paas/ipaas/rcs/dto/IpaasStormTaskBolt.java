/*
	* @(#)IpaasStormTaskBolt.java	2015年03月30日
	*
...
* @author weichuang
*/
public class IpaasStormTaskBolt implements java.io.Serializable{
	...
	//默认构造器
	public IpaasStormTaskBolt(){
	}
	//全属性构造器
	public IpaasStormTaskBolt(Long id,Long taskId,String boltName,String boltClassName,Integer threads,String groupingTypes,String groupingSpoutOrBlots){
		this.id = id;
		this.taskId = taskId;
	...
	public boolean equals(Object obj) {
		...
		return false;
		IpaasStormTaskBolt other = (IpaasStormTaskBolt) obj;
	if (id == null) {
		if (other.id != null)
			return false;

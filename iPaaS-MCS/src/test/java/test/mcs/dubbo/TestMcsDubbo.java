...
public class TestMcsDubbo {
	...
	public void create() {
		...
		String param ="{\"userId\":\"FFF49D0D518948D0AB28D7A8EEE25D03\",\"applyType\":\"create\",\"serviceId\":\"108\",\"capacity\":\"128\","
	...
	public void createCluster() {
		long s = System.currentTimeMillis();
		String param ="{\"userId\":\"FFF49D0D518948D0AB28D7A8EEE25D03\",\"applyType\":\"create\",\"serviceId\":\"106\",\"capacity\":\"128\",\"haMode\":\"cluster\"}";
		System.out.println("----------create-res:\n"+iMemoryCacheServiceManager.create(param));
	...
	public void modifyCluster() {
		long s = System.currentTimeMillis();
		String param ="{\"userId\":\"7E1080DCE0584729BEA8BBAFE6C6CAC8\",\"applyType\":\"modify\",\"serviceId\":\"MCS003\",\"capacity\":\"10240\",\"haMode\":\"cluster\"}";
		System.out.println("----------modify-res:\n"+iMemoryCacheServiceManager.modify(param));
	...
	public void stop() {
		long s = System.currentTimeMillis();
		String param ="{\"userId\":\"22E750F3714D4A078F5C765CA45CC841\",\"applyType\":\"stop\",\"serviceId\":\"MCS001\",\"capacity\":\"152\","
				+ "\"haMode\":\"single\",\"serviceName\":\"test\"}";
	...
	public void stopCluster() {
		long s = System.currentTimeMillis();
		String param ="{\"userId\":\"FFF49D0D518948D0AB28D7A8EEE25D03\",\"applyType\":\"stop\",\"serviceId\":\"106\",\"capacity\":\"256\",\"haMode\":\"cluster\"}";
		System.out.println("----------stop-res:\n"+iMemoryCacheServiceManager.stop(param));
	...
	public void start() {
		long s = System.currentTimeMillis();
		String param ="{\"userId\":\"FFF49D0D518948D0AB28D7A8EEE25D03\",\"applyType\":\"start\",\"serviceId\":\"104\",\"capacity\":\"152\","
				+ "\"haMode\":\"single\",\"serviceName\":\"test\"}";
	...
	public void startCluster() {
		long s = System.currentTimeMillis();
		String param ="{\"userId\":\"FFF49D0D518948D0AB28D7A8EEE25D03\",\"applyType\":\"start\",\"serviceId\":\"106\",\"capacity\":\"256\",\"haMode\":\"cluster\"}";
		System.out.println("----------start-res:\n"+iMemoryCacheServiceManager.start(param));
	...
	public void restart() {
		long s = System.currentTimeMillis();
		String param ="{\"userId\":\"FFF49D0D518948D0AB28D7A8EEE25D03\",\"applyType\":\"restart\",\"serviceId\":\"104\",\"capacity\":\"152\","
				+ "\"haMode\":\"single\",\"serviceName\":\"test\"}";
	...
	public void restartCluster() {
		long s = System.currentTimeMillis();
		String param ="{\"userId\":\"FFF49D0D518948D0AB28D7A8EEE25D03\",\"applyType\":\"restart\",\"serviceId\":\"106\",\"capacity\":\"256\",\"haMode\":\"cluster\"}";
		System.out.println("----------restart-res:\n"+iMemoryCacheServiceManager.restart(param));
	...
	public void get() {
		long s = System.currentTimeMillis();
		String param ="{\"userId\":\"FFF49D0D518948D0AB28D7A8EEE25D03\",\"serviceId\":\"104\",\"key\":\"a\"}";
		...
		String param1 ="{\"userId\":\"FFF49D0D518948D0AB28D7A8EEE25D03\",\"serviceId\":\"106\",\"key\":\"a\"}";

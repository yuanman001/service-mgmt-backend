package com.ai.paas.ipaas.ls.service.transfer.vo;
...
public class LSResult implements LSResultInterface{
	...
	public LSResult(int status, String discribe, String content, String exceptionTrace) {
		super();
		this.resultCode = String.valueOf(status);

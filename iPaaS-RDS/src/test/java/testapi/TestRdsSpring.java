...
@ContextConfiguration({ "classpath:dubbo/consumer/rds-consumer.xml" , "classpath:dubbo/consumer/applicationContext-mybatis.xml"})
public class TestRdsSpring {
	@Autowired
	private RDSInstanceManager incManager;
//	@Autowired
//	private RDSResourcePool resMananger;
//	@Autowired
//	private RDSInstanceOperater incOperater;
...
//		String result;
//		try {
//			result = incManager.cancel(request);
//			System.out.println("$$$$$$$$$$$$$$$$$$$$result$$$$$$$$$$$$$$$$$$$");
//			System.out.println(result);
//			System.out.println("$$$$$$$$$$$$$$$$$$$$result$$$$$$$$$$$$$$$$$$$");
//		} catch (MyException e) {
